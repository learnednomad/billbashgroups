...
const HomePage = () => {
  const heroData = {
    ...
    introParagraph: "Welcome to Bill Bash Group — your trusted partner in real estate, truck importation, farming, and spare parts sales. With a strong commitment to excellence and integrity, we provide reliable solutions across multiple industries to support individuals, businesses, and communities. Whether you're seeking premium properties, sourcing quality trucks, investing in agriculture, or in need of durable spare parts, Bill Bash Group delivers with professionalism, transparency, and a deep understanding of your needs.",
    ctaText: "Explore Our Services",
    ctaLink: "/about", 
    showIntro: true,
    heroImage: {
      alt: "Panoramic view of Bill Bash Group's diverse operations including modern city skyline for real estate, a fleet of trucks, a lush green farm, and an organized spare parts warehouse",
  ...
  return (
    <>
      ...
      <CtaSection 
        ...
        description="Discover how Bill Bash Group can support your goals. Contact us today for tailored solutions and expert advice."
