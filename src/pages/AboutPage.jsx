          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                Bill Bash Group is a dynamic and diversified company with a strong presence in real estate, truck importation, farming, and spare parts sales. We pride ourselves on delivering reliable, high-quality services tailored to meet the unique needs of our clients. Our journey is marked by continuous growth, innovation, and a deep understanding of the markets we serve.
              </p>
            ...
            >
              <img 
                alt="Modern office interior representing Bill Bash Group headquarters"
              ...
              >
                ...
                <div className="relative md:pl-8">
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-lg border-l-4 border-primary">
                    ...
                    <p className="text-gray-600">Bill Bash Group began as a small real estate consultancy in {yearFounded}, founded with a vision to provide exceptional property services and build lasting client relationships.</p>
                  </div>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="relative md:pl-8">
                  ...
                  <div className="bg-white p-6 rounded-lg shadow-lg border-l-4 border-primary">
                    ...
                    <p className="text-gray-600">Bill Bash Group ventured into the agricultural sector, focusing on sustainable farming practices. Today, we are a multi-faceted company committed to driving progress across all our operations.</p>
                  </div>
                </div>
              </motion.div>
            </div>
